...
<head>
    <title>Code coverage report for redis-pubsub.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> redis-pubsub.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import {Cluster, Redis, RedisOptions} from 'ioredis';
...
&nbsp;
  constructor(options: PubSubRedisOptions = {}) {
    const {
      ...
      serializer,
      deserializer,
      messageEventName = 'message'<span class="branch-1 cbranch-no" title="branch not covered" >,</span>
      pmessageEventName = 'pmessage'<span class="branch-1 cbranch-no" title="branch not covered" >,</span>
    } = options;
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (connectionListener) {
<span class="cstat-no" title="statement not covered" >          this.redisPublisher</span>
              .on('connect', connectionListener)
              .on('error', connectionListener);
<span class="cstat-no" title="statement not covered" >          this.redisSubscriber</span>
              .on('connect', connectionListener)
              .on('error', connectionListener);
        } else {
