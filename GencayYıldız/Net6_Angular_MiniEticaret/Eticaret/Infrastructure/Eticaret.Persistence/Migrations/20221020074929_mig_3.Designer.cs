...
namespace ETicaret.Persistence.Migrations
{
    ...
    [Migration("20221020074929_mig_3")]
    partial class mig_3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETicaret.Domain.Entities.CompletedOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ETicaret.Domain.Entities.Basket", b =>
                {
                    b.HasOne("ETicaret.Domain.Entities.Identity.AppUser", "User")
                        .WithMany("Baskets")
            ...
            modelBuilder.Entity("ETicaret.Domain.Entities.CompletedOrder", b =>
                {
                    b.HasOne("ETicaret.Domain.Entities.Order", "Order")
                        ...
                        .HasForeignKey("ETicaret.Domain.Entities.CompletedOrder", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
